...
# wandb.init(
#         project="LGSTNet_Road_Extraction",
#         name="RoadTrace_experiment_0",
...
def get_roadtrace_trainset(img_size):
    ...
    val_data_txt = '../Road_SWATNet/dataset/roadtracer_mydata/train_list_1024.txt'
...
def train(model_name, dataset_method, img_size, batch_size, log_name, checkpoint = '', lr = 1e-4, lr_end = 1e-6, total_epoch = 300):
    ...
    for epoch in range(1, total_epoch + 1):
        ...
        for index, (img, mask, names) in enumerate(data_loader_iter):
            ...
            # wandb.log({"train_loss": train_loss, "epoch": epoch, "lr": lr})
...
if __name__ == '__main__':
    ...
    train('LGSTNet', get_roadtrace_trainset, img_size = img_size, 
